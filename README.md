...
A real-time multiplayer card game built with a high-performance C++ backend and React frontend focused for mobile devices. Players compete in fast-paced poker-style rounds where they must decide whether to hold or drop their three-card hand.

Playable NOW: guts-production.up.railway.app
